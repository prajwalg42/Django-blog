...
DATABASES = {
    'default': {
        ...
        'NAME': 'djangoblog',  # database name in RDS is written here
        'USER': 'admin',  # database master username in RDS is written here
        'PASSWORD': config('PASSWORD'),
        # database endpoint is written here
        'HOST': 'database-1.cdgsq8uskaok.ap-south-1.rds.amazonaws.com',
...
AWS_STORAGE_BUCKET_NAME = 'djangoblog'  # please enter your s3 bucket name
